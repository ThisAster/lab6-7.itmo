...
public class ServerApp {
    ...
    private void listen(DatagramChannel server)
            throws ClassNotFoundException, InvalidRequestException, NotMaxException, NotMinException {
        while (true) {
            try {
                acceptConsoleInput();
    ...
    public static Map<String, AbstractCommand> createClientCommandsMap(OutputManager outputManager,
